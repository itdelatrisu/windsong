...
public class MusicController {
	...
	private static PotatoMap lastMap;
	 ...
	 */
	public static void play(final PotatoMap map, final boolean loop) {
	 ...
	 */
	public static PotatoMap getMap() { return lastMap; }
	...
	public static void playThemeSong() {
		PotatoMap map = Options.getThemeMap();
		if (map != null) {
			play(map, true);
			themePlaying = true;
		}
